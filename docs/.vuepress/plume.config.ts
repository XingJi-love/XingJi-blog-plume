...
export default defineThemeConfig({
  ...
  navbarSocialInclude: ['github','gitee','csdn','leetcode','bilibili'], // 允许显示在导航栏的 social 社交链接
  // aside: true, // 页内侧边栏， 默认显示在右侧
  outline: [1, 6], // 页内大纲， 默认显示h1-h6标题 
