...
![](./XML_Tomcat_HTTP/img-1.jpg)



#### http长链接和短链接的问题

![](./XML_Tomcat_HTTP/img-2.jpg)

> **页面请求的相关资源:**

![](./XML_Tomcat_HTTP/img-3.jpg)



#### http1.0(短链接)

> 缺点: 多次请求服务端(Tomcat),浪费资源

![](./XML_Tomcat_HTTP/img-4.jpg)



#### http1.1(短链接)

![](./XML_Tomcat_HTTP/img-5.jpg)
...
![](./XML_Tomcat_HTTP/img-7.jpg)

+ **302：** 重定向，当响应码为302时，表示服务器要求浏览器重新再发一个请求，服务器会发送一个响应头Location指定新请求的URL地址；

+ **304：** 使用了本地缓存

![](./XML_Tomcat_HTTP/img-8.jpg)

+ **404：** 请求的资源没有找到，说明客户端错误的请求了不存在的资源；

![](./XML_Tomcat_HTTP/img-9.jpg)

+ **405：** 请求的方式不允许

> **错误请求方式:**

![](./XML_Tomcat_HTTP/img-10.jpg)

> **正确请求方式:**

![](./XML_Tomcat_HTTP/img-11.jpg)

+ **500：** 请求资源找到了，但服务器内部出现了错误；

![](./XML_Tomcat_HTTP/img-12.jpg)
